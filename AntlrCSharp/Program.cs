...
class Program 
{
    static void Main() 
    {
         string code = File.ReadAllText("c:\\uni_study\\2.2\\metrology\\Complexity_Parser_Swift\\test_gilb_metrics.swift");
        // string code ="   if y > 50 {        if x < 100 {            return 5        } else {            return 4        }    } else {        return 1     }";
